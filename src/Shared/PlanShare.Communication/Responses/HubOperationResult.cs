...
public class HubOperationResult<TResponse>
{
    ...
    public static HubOperationResult<TResponse> Failure(string errorMessage, UserConnectionErrorCode errorCode) => new() { IsSuccess = false, ErrorMessage = errorMessage, ErrorCode = errorCode };
}
