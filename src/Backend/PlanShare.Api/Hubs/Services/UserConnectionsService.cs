...
{
    private readonly ConcurrentDictionary<string, ConnectionByCodeDto> _connectionsByCode = [];
    ...
    {
        var userConnection = new ConnectionByCodeDto
        {
            Code = code,
            Generator = generator,
    ...
    public ConnectionByCodeDto? GetConnectionByCode(string code)
    {
    ...
    public ConnectionByCodeDto? RemoveConnectionByCode(string code)
    {
