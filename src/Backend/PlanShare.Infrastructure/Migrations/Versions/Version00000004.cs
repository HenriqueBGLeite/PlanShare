...
public class Version00000004 : VersionBase
{
    public override void Up()
    {
        CreateTable("UserConnections")
            .WithColumn("UserId").AsGuid().NotNullable().ForeignKey("FK_UserConnections_UserId", "Users", "Id")
            .WithColumn("ConnectedUserId").AsGuid().NotNullable().ForeignKey("FK_UserConnections_ConnectedUserId", "Users", "Id");
    }
}
